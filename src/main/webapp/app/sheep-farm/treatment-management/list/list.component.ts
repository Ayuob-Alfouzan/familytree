...
import { ListSheepTreatmentService } from './list.service';
...
@Component({
  selector: 'jhi-list-sheep-treatment',
  templateUrl: './list.component.html',
})
export class ListSheepTreatmentComponent implements OnInit {
  ...
  constructor(
    public service: ListSheepTreatmentService,
