...
@Injectable()
export class NotPregnantReportService {
  loading = true;
  list: any;
  ...
  loadFromServer(): Observable<SheepModel[]> {
    return this.http
      .post<Pageable<SheepModel>>(this.applicationConfigService.getEndpointFor('api/sheep-report/not-pregnant'), this.createBody(), {
