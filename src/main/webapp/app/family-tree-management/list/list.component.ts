...
import { ListFamilyTreeService } from './list.service';
import { NgbdSortableHeaderDirective, SortEvent } from '../sortable.directive';
import { LanguageService } from 'app/shared/language/language.service';
import { AccountService } from 'app/core/auth/account.service';

@Component({
  selector: 'jhi-list-family-tree',
  templateUrl: './list.component.html',
})
export class ListFamilyTreeComponent implements OnInit {
  ...
  constructor(
    public service: ListFamilyTreeService,
