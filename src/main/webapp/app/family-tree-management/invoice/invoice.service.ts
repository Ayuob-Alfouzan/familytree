...
export class InvoiceService {
  ...
  print(familyTreeId: number, invoiceId: number): Observable<Blob> {
    return this.http.get(this.applicationConfigService.getEndpointFor(`api/invoice/print/${familyTreeId}/${invoiceId}`), {
      responseType: 'blob',
    });
  }
